...
Note that the project assumes a connection to a REST API serve with appropriate CFD data, as well as an [MQTT](http://mqtt.org/) broker service for sensor data.
